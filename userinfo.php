<?php
    ...
    if(isset($_REQUEST['logoutbtn']))
    {
		...
		$sql3 = "SELECT * FROM useremail where user_eid = '$id' ";
...
<html>
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="#"><i class="fa fa-fw fa-search"></i> Users Information</a>
          </li>
          <li class="nav-item">
	...
	<div class="container-fluid">
		<div>
			<div class="col-sm-6" style="padding-top: 2%; padding-left: 4%;"><h1 class="fontsize5">Result</h1></div>
		</div>
	</div>
	...
	<div style="padding-left: 4%;"><p style="border:2px solid orange; width: 15%; height: 0px;" ></p></div>
		...
		<div class="container" style="margin-top: 5%;">
					...
					<form action="searchforinfo.php" method="POST">
							...
							<div class="jumbotron text-center" style="background-color: white;">
								<br><input type="submit" class="btn btn-primary" name="back" value="Back To Search" style="font-size: 20px;" />
							</div>
