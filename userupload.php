...
<a href="admin.php" class="btn btn-primary" style="margin-top: 1%; margin-left: 1%; font-size: 20px;">Back</a>
	...
	<div class="container-fluid">
		<div>
			<div class="col-sm-6" style="padding-top: 2%; padding-left: 4%;"><h1 class="fontsize5">Search Here to get Uploaded book of User</h1></div>
		</div>
	</div>

	<div style="padding-left: 4%;"><p style="border:2px solid orange; width: 15%; height: 0px;" ></p></div>

	<form name="form1" action="useruploadedinfo.php" onsubmit="return checkid()" method="POST">
