...
<html>
	<head>
		...
		<script>
                 function checkid()
				   {
                       var numid=document.form1.usersid.value;
...
if($_SESSION['show']==1)
  {
	  echo "<h5 class='alert alert-success'>Deleted Successfully!!</h5>";
  }
...
?>
	...
	<form name="form1" action="deletelist.php" onsubmit="return checkid()" method="POST">
						...
						<div style="padding: 1px;">
							<div class="jumbotron text-center" style="background-color: #e6ffff;">
								<div class="form-group">
              						<label style="font-size: 20px;">Enter User ID to Delete : </label>
            						<input type="text" name="usersid" class="form-control"><br>

									<input type="submit" value="Proceed" name="subbtn" class="btn btn-primary" style="margin-top: 3%; font-size: 20px;">
            					</div>
							</div>
						</div>
					</div>
