<?php
    ...
    if(isset($_REQUEST['logoutbtn']))
    {
		...
		$sql2 = "SELECT * FROM sold_books where sold_buyer_id = '$useridpro' ";
		//echo $sql2;
...
<a href="userpurchase.php" class="btn btn-primary" style="margin-top: 1%; margin-left: 1%; font-size: 20px;">Back</a>
